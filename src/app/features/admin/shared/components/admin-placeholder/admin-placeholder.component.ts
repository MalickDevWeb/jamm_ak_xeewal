...
@Component({
  ...
  template: `
    <div class="animate-fade-in-up bg-white p-12 rounded-3xl shadow-sm border border-gray-100 text-center relative overflow-hidden">
      ...
      <div class="relative z-10 flex flex-col items-center justify-center">
        ...
        <h2 class="text-3xl font-black text-gray-900 mb-2 capitalize">{{ currentPath }}</h2>

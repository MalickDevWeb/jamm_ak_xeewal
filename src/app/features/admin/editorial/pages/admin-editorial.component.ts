...
@Component({
  ...
  <div class="animate-fade-in-up">
    <div class="mb-8">
      <h2 class="text-2xl font-black text-gray-900">Contenu Éditorial</h2>
    ...
    <div class="flex gap-2 mb-6">
      <button (click)="activeTab = 'home'"
        [class]="activeTab === 'home' ? 'px-5 py-2.5 bg-[#022c16] text-white rounded-xl text-sm font-bold shadow' : 'px-5 py-2.5 bg-white text-gray-600 rounded-xl text-sm font-bold border border-gray-200 hover:bg-gray-50 transition-colors'">
        <i class="fa-solid fa-house mr-2"></i> Accueil
      </button>
      <button (click)="activeTab = 'mouvement'"
        [class]="activeTab === 'mouvement' ? 'px-5 py-2.5 bg-[#022c16] text-white rounded-xl text-sm font-bold shadow' : 'px-5 py-2.5 bg-white text-gray-600 rounded-xl text-sm font-bold border border-gray-200 hover:bg-gray-50 transition-colors'">
        <i class="fa-solid fa-seedling mr-2"></i> Le Mouvement
      </button>
      <button (click)="activeTab = 'axes'"
        [class]="activeTab === 'axes' ? 'px-5 py-2.5 bg-[#022c16] text-white rounded-xl text-sm font-bold shadow' : 'px-5 py-2.5 bg-white text-gray-600 rounded-xl text-sm font-bold border border-gray-200 hover:bg-gray-50 transition-colors'">
    ...
    <div *ngIf="activeTab === 'home'" class="space-y-6">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <h3 class="text-base font-bold text-gray-900 mb-5 flex items-center gap-2">
          <div class="w-7 h-7 rounded-lg bg-[#022c16]/10 text-[#022c16] flex items-center justify-center text-xs"><i class="fa-solid fa-camera"></i></div>
          Photo du Président
        </h3>
        <div class="space-y-4">
          <div>
          ...
          <div *ngIf="home.presidentPhoto" class="mt-3">
            <img [src]="home.presidentPhoto" alt="Aperçu" class="w-32 h-32 object-cover rounded-xl border border-gray-200">
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Titre de la section</label>
            <input [(ngModel)]="home.title" type="text"
              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all"
              placeholder="Ensemble, bâtissons le Thiès-Nord de demain">
          </div>
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Nom du Président</label>
            <input [(ngModel)]="home.presidentName" type="text"
              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all"
              placeholder="Nom complet du président">
          </div>
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Message (HTML supporté)</label>
            <textarea [(ngModel)]="home.message" rows="8"
              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all resize-none"
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Citoyens actifs</label>
            <input [(ngModel)]="home.stat1Value" type="text"
              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all"
              placeholder="500+">
            <input [(ngModel)]="home.stat1Label" type="text"
              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all mt-2"
              placeholder="Citoyens actifs">
          </div>
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Quartiers</label>
          ...
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Actions réalisées</label>
    ...
    <div *ngIf="activeTab === 'mouvement'" class="space-y-6">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <h3 class="text-base font-bold text-gray-900 mb-5 flex items-center gap-2">
          <div class="w-7 h-7 rounded-lg bg-[#022c16]/10 text-[#022c16] flex items-center justify-center text-xs"><i class="fa-solid fa-heading"></i></div>
          Section Hero — "Qui sommes-nous ?"
        </h3>
        <div class="space-y-4">
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Sous-titre de page</label>
            <input [(ngModel)]="mouvement.heroSubtitle" type="text"
              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all">
          </div>
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Titre principal</label>
            <input [(ngModel)]="mouvement.heroTitle" type="text"
              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all">
          </div>
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Paragraphe principal</label>
            <textarea [(ngModel)]="mouvement.heroParagraph" rows="4"
              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all resize-none"></textarea>
          </div>
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Sous-paragraphe (3 piliers)</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div class="bg-gray-50/50 rounded-xl p-4 border border-gray-100">
            <div class="flex items-center gap-2 mb-3">
              <div class="w-6 h-6 bg-green-100 text-green-700 rounded-lg flex items-center justify-center text-xs"><i class="fa-solid fa-eye"></i></div>
              <span class="text-sm font-bold text-gray-700">Notre Vision</span>
            </div>
            <textarea [(ngModel)]="mouvement.vision" rows="4"
              class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all resize-none bg-white"></textarea>
          </div>
          <div class="bg-gray-50/50 rounded-xl p-4 border border-gray-100">
            <div class="flex items-center gap-2 mb-3">
              ...
              <span class="text-sm font-bold text-gray-700">Notre Mission</span>
            </div>
          ...
          <div class="bg-gray-50/50 rounded-xl p-4 border border-gray-100">
            <div class="flex items-center gap-2 mb-3">
              <div class="w-6 h-6 bg-[#022c16]/10 text-[#022c16] rounded-lg flex items-center justify-center text-xs"><i class="fa-solid fa-heart"></i></div>
              <span class="text-sm font-bold text-gray-700">Nos Valeurs</span>
            </div>
            <textarea [(ngModel)]="mouvement.valeurs" rows="4"
              class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all resize-none bg-white"
    ...
    <div *ngIf="activeTab === 'axes'" class="space-y-6">
      ...
      <!-- Les 3 pôles -->
      <div *ngFor="let pole of axes.poles; let i = index" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <h3 class="text-base font-bold text-gray-900 mb-5 flex items-center gap-2">
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Titre du pôle</label>
            <input [(ngModel)]="pole.titre" type="text"
              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all">
          </div>
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Sous-titre</label>
            <input [(ngModel)]="pole.soustitre" type="text"
              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all">
          </div>
          <div>
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Actions (une par ligne)</label>
            <textarea [(ngModel)]="pole.actions" rows="5"
              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#022c16]/20 focus:border-[#022c16] transition-all resize-none font-mono text-xs"></textarea>
          </div>
        </div>
      </div>
